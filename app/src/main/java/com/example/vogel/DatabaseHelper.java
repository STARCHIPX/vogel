...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 2; // Erhöhen Sie die Version bei jeder Schemaänderung
    ...
    public boolean insertSelection(String option, String timeOfDay, String areaName) {
